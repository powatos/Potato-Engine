        ...
        if (id == EventID) {
            ...
            for (const std::any& binding : bindingList) {
                ...
                try {
                    ...
                    LOG_DEFAULT(LogType::ERROR, "While firing event"s + e.what());
                }
            }
    ...
    for (auto& [id, bindingList] : Bindings) {
        ...
        for (auto it = bindingList.begin(); it != bindingList.end();) {
            ...
            try {
                ...
                LOG_DEFAULT(LogType::ERROR, "While unregistering native event by object: "s + e.what());
            }
    ...
    for (auto& [id, bindingList] : Bindings) {
        ...
        for (auto it = bindingList.begin(); it != bindingList.end();) {
            ...
            try {
                ...
                LOG_DEFAULT(LogType::ERROR, "While unregistering native event by name: "s + e.what());
            }
